/**
 * Core utility types for PowerTimeline component
 */

import type { ScaleTime } from 'd3-scale';

// ============================================================================
// TIME AND SCALE TYPES
// ============================================================================
...
export interface VirtualizationState {
  ...
  /** Buffered time range including buffer zone */
  bufferedTimeRange: TimeRange;
  
  /** Items visible in the buffered range */
  visibleItems: Item[];
...
// ============================================================================
// EVENT ITEM TYPES (Point-in-Time)
// ============================================================================
...
// ============================================================================
// TIME RANGE ITEM TYPES (Duration-Based)
// ============================================================================
